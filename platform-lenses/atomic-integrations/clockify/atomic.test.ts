...
vi.mock('@tomic/lib', async () => ({
  ...(await import('@integration-host/ontologies/core')),
  ...(await import('@integration-host/ontologies/dataBrowser')),
  ...(await import('@integration-host/time-tracking-schema')),
  findSchema: vi.fn(),
