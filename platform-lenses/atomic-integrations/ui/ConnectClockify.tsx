...
import { constructOpenURL } from '@integration-host/navigation';
import { timeTrackerTables, type TimeTableTarget } from '../clockify/atomic';
import { useAddToOntology } from '@hooks/useAddToOntology';
import {
  buildTableFromSpec,
  type BuildTableResult,
} from '@integration-host/table/createTableFromSpec';
import { TABLE_TEMPLATES } from '@integration-host/table/tableTemplates';
import { RunPluginDialog } from '@integration-host/RunPluginDialog';
import { createPlugin, setPluginSource } from '@integration-host/runScript';
import { manifest, origin, type Config } from '../clockify/model';
import source from '../clockify/plugin.js?raw';
